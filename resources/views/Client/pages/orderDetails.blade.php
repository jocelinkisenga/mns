                            ...
                            <div class="invoice p-3 mb-3 ">
                                ...
                                <div class="html-content" id="myPrintable">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <img src="{{ asset('admin/dist/img/credit/mastercard.png') }}"
                                                alt="Mastercard">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <th>Total:</th>
                                                        <td>{{ $order->amount + ($order->amount / 100) * 16 }} $
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                ...
                                <div class="row no-print">
                                    <div class="col-12">
                                        ...
                                        <button onclick="CreatePDFfromHTML()" class="btn btn-primary float-right"
