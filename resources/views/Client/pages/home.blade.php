            ...
            <div class="w-full flex flex-col gap-2">
              <div class="flex justify-center">
                <div class="flex bg-white shadow-lg p-3 rounded-full">
                  <img src="{{asset('client/assets/images/bar_icon_127276.png')}}" alt="category name" width="30"
                    class="w-7 h-7 sm:w-10 sm:h-10 md:w-12 md:h-12">
                </div>
              </div>
              <div class="flex justify-center">
                <h3 class="text-center text-sm sm:text-base md:text-lg">Category name</h3>
              </div>
            </div>
          </a>
          <a href=""
        ...
        <div class="grid xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 sm:gap-4 md:gap-6">
          ...
          <div
            ...
            <div class="flex w-full bg-gray-100">
              <img src="{{asset('client/assets/images/products/splendide-12.jpg')}}" width="40" height="auto" alt="image produits"
            ...
            <div class="flex w-full flex-col px-2 pb-2 sm:px-4 sm:pb-4 pt-2 sm:gap-2">
              ...
              <div class="flex w-full items-center flex-wrap gap-1 small:gap-0 small:flex-nowrap justify-between">
                <h2 class="font-bold text-lg flex text-gray-600">25000 <span class="pl-1 text-pink-500">CDF</span>
                </h2>
              </div>
      ...
      <div>
        <div class="flex flex-col gap-y-5">
          ...
          <div class="grid md:grid-cols-3 gap-4">
            <div class="col-span-1 flex flex-col md:flex-row border-pink-600 border rounded-md px-5 lg:px-2 lg:py-4 py-3 justify-center gap-2">
              <div class=" min-w-[3.5rem] text-pink-600 flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10 md:h-14 md:w-14">
            ...
            <div class="col-span-1 flex flex-col md:flex-row border-pink-600 border rounded-md px-5 lg:px-2 lg:py-4 py-3 justify-center gap-2">
              <div class=" min-w-[3.5rem] text-pink-600 flex items-start">
                ...
                class="w-10 h-10 md:h-14 md:w-14">
    ...
    <div class="appContainer">
      <div class="grid bg-gradient-to-tl from-gray-50 to-gray-300 md:grid-cols-3 gap-6 items-center relative rounded-xl overflow-hidden">
        ...
        <div class="hidden md:flex col-span-1 h-full relative overflow-hidden">
          <div class="w-full">
            <img src="{{asset('client/assets/images/disinfecting-in-home.jpg')}}" alt="image product" width="300" height="auto"
