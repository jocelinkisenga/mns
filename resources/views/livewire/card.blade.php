        ...
        <div class="space-y-2 mb-10">
          @if (session()->has('basket'))
              ...
              <div class="w-32 min-w-max">
                <img src="{{asset('storage/uploads/'.$item['photo'])}}" class="w-full object-cover rounded h-16 sm:h-20 md:h-24">
              </div>
              ...
              <div class="flex border border-gray-300 text-gray-600 divide-x divide-gray-300">
                ...
                <input type="number" name="" id="" class="h-8 w-10 flex items-center justify-center px-2 text-center" value="{{$item['quantity']}}">
